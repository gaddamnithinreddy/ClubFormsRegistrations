  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-100 to-blue-200 dark:from-gray-900 dark:to-gray-800 px-4 w-full h-full fixed inset-0 overflow-auto">
      <div className="w-full max-w-md flex flex-col items-center justify-center">
        {/* Animation container with fixed height to prevent content shifting */}
        ...
        {/* Form container with its own scrolling if needed */}
        <motion.div 
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="w-full space-y-6 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm p-8 rounded-2xl shadow-xl"
        >
          <div>
            <motion.h2 
              initial={{ scale: 0.95 }}
